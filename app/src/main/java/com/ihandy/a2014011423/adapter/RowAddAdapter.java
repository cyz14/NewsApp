 ...
 *
 */
public class RowAddAdapter extends BaseAdapter { // unwatched
    private LayoutInflater inflater;
    private List<CategoryLabel> data;
    private Handler handler;

    public RowAddAdapter(Context context, Handler handler, List<CategoryLabel> data) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.category_add_row, null);
            ...
            viewHolder.imageView.setOnClickListener(new ArrowOnClickListener(data.get(i)));
    ...
    private class ArrowOnClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            msg.arg1 = CategorySettingActivity.ARROW_UP;
